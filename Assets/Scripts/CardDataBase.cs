...
public class CardDataBase : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(17, "Quadropticus", 1, 400, 200, Type.Marine, Attribute.Water, Property.Hydrowalk, "With eyes in every direction, it can effortlessly move through the labyrinth's depths. Rumor has it, it enjoys staring contests", Resources.Load<Sprite>("quadropticus"), "Brown", 0, 0, false, 0, true));
